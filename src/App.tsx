...
import { ICON, at, cleanup, declineCleanup, defend, isPawnAmbush, legal, name, newGame, queue, removeOrder, resolve, same } from "./game/simultaneous";
...
export default function App() {
  ...
  return <main className="core-shell">
    ...
    <section className="core-rule"><strong>Three orders each turn.</strong> Choose a piece and destination, or order it to defend in place, then resolve both sides simultaneously. Moving into an idle enemy is a free hit; defending converts that hit into a trade.</section>
